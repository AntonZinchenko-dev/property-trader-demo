...
export type Property = {
  ...
  { tile: 5,  name: 'Reading Railroad', price: 200, rent: 25 },
  ...
  { tile: 12, name: 'Electric Company', price: 150, rent: 12 },
    { tile: 13, name: 'Pink 2', price: 140, rent: 10 },
    { tile: 14, name: 'Pink 3', price: 160, rent: 12 },
  { tile: 15, name: 'Pennsylvania Railroad', price: 200, rent: 25 },
  ...
  { tile: 25, name: 'B. & O. Railroad', price: 200, rent: 25 },
  
    { tile: 26, name: 'Yellow 1', price: 260, rent: 22 },
    { tile: 27, name: 'Yellow 2', price: 260, rent: 22 },
  { tile: 28, name: 'Water Works', price: 150, rent: 12 },
  ...
  { tile: 35, name: 'Short Line Railroad', price: 200, rent: 25 },
